<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $deliverieQuery = $conn->prepare("INSERT INTO deliveries (user_id, lastname, firstname, adress_1, city, region, [postal-code], country, phone) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");

        $billingQuery = $conn->prepare("INSERT INTO billings (user_id, lastname, firstname, adress_1, city, region, [postal-code], country) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
